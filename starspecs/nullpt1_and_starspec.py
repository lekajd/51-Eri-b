...
# Spectral Extraction
exspec_outpath = outpaths[1]
prefix = prefixes[1] # fileprefix for the output files
...
# Save Star Spectra
print("Saving star spectra...")
wvs = list(wvs)
F = list(star_spectrum)
dict = {f'Wavelength ({sp.waveunits})': wvs, 
                f'F ({sp.fluxunits})': F}
dfss = pd.DataFrame(dict)
dfss.to_csv(exspec_outpath+f'/starspec1.csv')
print("Finished saving star spectra!")

# # Save Exoplanet Spectra
# print("Saving exoplanet spectra...")
# i = 0
...
#         i = i + 1
# print("Finished saving exoplanet spectra!")